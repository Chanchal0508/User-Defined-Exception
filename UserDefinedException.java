 ...
 * 1)Our class should be part of the Exception hierarchy. So we should extend our
 * class with either Exception class:-this will make our exception a compileTime
 * exception or extend with RunTimeException class:- this will make our exception
 * a runtime exception.
 * 
...
public class UserDefinedException {
	...
	public static void main(String[] args) {
		 ...
		 * Most commonly we use throw keyword when we want to generate our own 
